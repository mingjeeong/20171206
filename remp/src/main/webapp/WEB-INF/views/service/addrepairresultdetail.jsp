...
<form name="repairResultForm" id="repairResultForm">
<table id="repairForm" class="table table-striped table-hover table-bordered table-sm">
	...
	<tr>
		<th>점검분류</th>
		<td><select id="repairSort" class="form-control" name="repairSort" required>
				<option value="" >==선택하세요==</option>
				<option value="내부수리완료" id="wa_product">내부수리완료</option> 
				<option value="수리대기" id="wa_repair">수리대기</option>
				<option value="외부수리" id="re_exoutput">외부수리</option>
				<option value="수리불가능" id="re_disuse">수리불가능</option>
			</select>
		</td>
	</tr>
	<tr>
